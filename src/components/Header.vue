...
<template>
  <div v-if="infoOpen" class="info">
    <div>
      ...
      <p>
        <strong>Söz Söweşleri </strong>
        <a class="link" href="https://twitter.com/indikimen">@indikimen</a>
        tarapyndan türkmen diline öwrüldi. Asyl oýun (Wordle Wars)
        <a class="link" href="https://twitter.com/ctnicholasdev"
          >@ctnicholasdev</a
        >
        tarapyndan ýasaldy we kodlaryna
        <a
          target="_blank"
          class="link"
          href="https://github.com/CTNicholas/wordle-wars"
          >GitHubdan</a
        >
        ulaşyp bilersiňiz.
      </p>
      <div class="divider" />
      <h2 class="mt-6">Nädip oýnamaly</h2>
      <p>Dogry <strong>SÖZi</strong> 6 çaklamada tapjak boluň</p>
      <p>
        Her çaklama 5 harply dogry söz bolmalydyr. Ibermek üçin enter basyň.
      </p>
      <p>
        Her çaklamadan soň gutularyň reňkleri, çaklamalaryňyzyň ýakynlygyna görä
        üýtgär.
      </p>
      <p>
        Iň az çaklama bilen dogry sözi tapan ýeniji bolar.
        <br />
        <strong>Söz Söweşleri</strong>.
      </p>
      <div class="divider" />
      <p>
        <strong>Mysallar</strong>
      </p>
      <div class="example">
        <p>
          <MiniBoard
            :large="true"
            :showLetters="true"
            :user="{ board: messages.abray }"
            :rows="messages.abray.length"
          />
        </p>
        <p><strong>A</strong> harpy sözde bar ve dogry ýerde.</p>
      </div>
      <div class="example">
        <p>
          <MiniBoard
            :large="true"
            :showLetters="true"
            :user="{ board: messages.dileg }"
            :rows="messages.dileg.length"
          />
        </p>
        <p><strong>I</strong> harpy sözde bar, ýöne ýalňyş ýerde.</p>
      </div>
      <div class="example">
        <p>
          <MiniBoard
            :large="true"
            :showLetters="true"
            :user="{ board: messages.gyrat }"
            :rows="messages.gyrat.length"
          />
        </p>
        <p>Hiç bir harp sözde ýok.</p>
      </div>
      <div class="divider" />
      <p>
        <strong>Her gün täze SÖZ üçin oýnap bilersiňiz!</strong>
      </p>
    </div>
  </div>
  <header>
