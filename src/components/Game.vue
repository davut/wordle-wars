  ...
  <div id="board-wrapper">
    <div id="board">
      ...
      >
        ...
        <div v-if="success">Beýleki oýunçylaryň gutarmagyna garaşýarys...</div>
      </div>
